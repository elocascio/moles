...
colors = {'Hydrophobic': 'purple', 'Pi_stacking_T': 'black', 'Pi_stacking_P': 'coral', 'Salt_Bridge': 'mediumblue', 'H_bond':'aqua', 'Pi_Cation':'firebrick', 'Water_Bridge':'gold', 'Metal_Coordination':'lawngreen'}
